CREATE DATABASE  IF NOT EXISTS `proyecto_lpf` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `proyecto_lpf`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: proyecto_lpf
-- ------------------------------------------------------
...
CREATE TABLE `boleta` (
  ...
  CONSTRAINT `fk_idcliente` FOREIGN KEY (`idcliente`) REFERENCES `promotor` (`codigoPromotor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_idusuario` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`codigoUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `boleta` VALUES (1,1,35,'2018-12-03');
...
CREATE TABLE `detalle_boleta` (
  ...
  CONSTRAINT `fk_idboleta` FOREIGN KEY (`idboleta`) REFERENCES `boleta` (`idboleta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_iddna` FOREIGN KEY (`iddna`) REFERENCES `dna` (`codigoDna`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `detalle_boleta` VALUES (1,7,70);
...
CREATE TABLE `dna` (
  ...
  CONSTRAINT `fk_Dna_Promotor` FOREIGN KEY (`codigoPromotor`) REFERENCES `promotor` (`codigoPromotor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `promotor` VALUES (34,'Fabiola','Sanchez Quispe',19,149,1503,'mz o lt 2',44348209,2,985647879,'fabiola.sanchez@gmail.com',3),(35,'Franco Antonio','Huaman Guevara',17,144,1475,'Mz D Lt 16 Av. San Antonio',8456123,1,951456254,'arnold.v@gmail.com',4);
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `usuario_cargo` FOREIGN KEY (`idCargo`) REFERENCES `cargo` (`idCargo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `usuario` VALUES (1,'Xamir','Diaz Caballero','xdiazc','xdiazc','xdiaz@gmail.com','1992-02-11',1),(2,'Ronal','Huaccha Rivera','rhuacchar','rhuacchar','ronal_huaccha@gmail.com','1992-05-11',2),(3,'Franco ','Huaman Guevara','fhuamang','fhuamang','franco_huaman@gmail.com','1999-03-11',3),(4,'Geraldine ','Jayo Escalante','gjayo','gjayo','geraldine.jayo@gmail.com','1999-10-11',4);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'proyecto_lpf'
--
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarDNAxCaracteres`(in vnomDNA varchar(45))
BEGIN
...
where d.nombreDNA like vnomDNA;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
select u.codigoUsuario,u.nombreUsuario,u.apellidoUsuario,u.idUsuario,u.passwordUsuario,u.correoUsuario,u.fechaUsuario,c.nombreCargo from usuario u inner join cargo c
on u.idCargo=c.idCargo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2018-12-03 14:32:16
